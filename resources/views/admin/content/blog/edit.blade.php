        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title">
                        <i class="fas fa-edit me-2"></i>Edit Blog Post: {{ Str::limit($post->title, 30) }}
                    </h3>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.content.blog.update', $post->id) }}" method="POST" enctype="multipart/form-data" id="blogEditForm">
                        @csrf
                        @method('PATCH')
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content" id="content" class="form-control @error('content') is-invalid @enderror" 
                                              required style="display: none;">{{ old('content', $post->content) }}</textarea>
                                    @error('content')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="excerpt" id="excerpt" class="form-control @error('excerpt') is-invalid @enderror" 
                                              rows="3" placeholder="A brief summary of your post (will be auto-generated if left empty)">{{ old('excerpt', $post->excerpt) }}</textarea>
                                    <div class="form-text">
                                        <small class="text-muted">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group" id="scheduled_at_field" style="{{ old('status', $post->status) == 'scheduled' ? '' : 'display: none;' }}">
                                        ...
                                        <div class="mt-3 pt-3" style="border-top: 1px solid #dee2e6;">
                                            <small class="text-muted">
                                                ...
                                                @endif
                                                <div><strong>Views:</strong> {{ $post->views ?? 0 }}</div>
                                            </small>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tags" id="tags" class="form-control @error('tags') is-invalid @enderror" 
                                                   value="{{ old('tags', $tags) }}" placeholder="travel, tips, guide, vacation">
                                            <div class="form-text">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @if($post->featured_image)
                                            <div class="current-image-section mb-3">
                                                ...
                                                <div class="text-center">
                                                    <img src="{{ url(Storage::url('app/public/' . $post->featured_image)) }}" 
                                                         class="current-featured-image img-fluid" 
                                                         alt="Current featured image">
                                                </div>
                                                <div class="remove-image-section mt-2">
                                                    <div class="form-check">
                                                        <input type="checkbox" name="remove_featured_image" id="remove_featured_image" class="form-check-input">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label">
                                                <span 
                                                title="{{ url(Storage::url($post->featured_image)) }}">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="meta_description" id="meta_description" 
                                                      ...
                                                      rows="3" placeholder="Brief description for search engines">{{ old('meta_description', $post->meta_description) }}</textarea>
                                            <div class="form-text">
                                                <small class="text-muted">
        ...
        reader.onload = function(e) {
            previewDiv.innerHTML = `
                <div class="mt-3">
                    ...
                    <img src="${e.target.result}" class="image-preview img-fluid d-block" alt="New image preview">
                    <div class="mt-2">
                        <small class="text-muted">${file.name} (${(file.size / 1024).toFixed(1)} KB)</small>
                        <button type="button" class="btn btn-sm btn-danger ms-2" onclick="removeNewImage()">
...
// Preview post (placeholder - you can implement this)
...
function addAutoExcerptButton() {
    ...
    if (excerptGroup && !excerptGroup.querySelector('.auto-excerpt-btn')) {
        const autoButton = document.createElement('button');
        autoButton.type = 'button';
        autoButton.className = 'btn btn-sm btn-outline-secondary mt-1 auto-excerpt-btn';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('🚀 Blog edit form initialized successfully!');
});
